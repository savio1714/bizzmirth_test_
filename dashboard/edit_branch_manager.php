...
require '../connect.php';
    ...
    $stmt = $conn->prepare("SELECT *, (select city_name from cities where id = '".$city."'), (select state_name from states where id = '".$state."') as statename, (select city_name from cities where id = '".$city."') as city_name,(select country_name from countries where id = '".$country."') as countryname FROM `branch_manager` where branch_manager_id ='".$id."'");
    $stmt->execute();
...
<head>
    ...
    <title>Edit Branch Manager | Bizzmirth Holidays</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 padding-right-30">
                        <div class="dashboard-list-box">
                            <h4 class="gray">Edit Branch Manager Details</h4>
                            <div class="dashboard-list-box-static">
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <label>Branch Manager First Name</label>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <label>Branch Manager Last Name</label>
