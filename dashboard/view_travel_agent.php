                               ...
                               <thead>
                                ...
                                <tbody>
                                     ...
                                     <?php
                                                require '../connect.php';
                                                $srno =1;
                                                $stmt = $conn->prepare("SELECT * FROM travel_agent where user_type='3' and reference_no='".$user_id."' and status='1' order by travel_agent_id");
                                                $stmt->execute();
                                                ...
                                                if($stmt->rowCount()>0){
                                                    ...
                                                    <button type="button"  onclick=\'deletefunc("' .$row["travel_agent_id"]. '")\' class="btn btn-danger">Delete</button>
                                                    </td>
