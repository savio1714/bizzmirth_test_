                            ...
                            <nav class="pagination">
                                <ul>
                                    ...
                                    echo "</br>";     
                                        ...
                                        if($page>=2){   
                                            echo "<li><a href='view_sales_manager.php?page=".($page-1)."'> <i class='sl sl-icon-arrow-left'></i> </a></li>";   
                                        }       
                                                   
                                        for ($i=1; $i<=$total_pages; $i++) {   
                                          if ($i == $page) {   
                                              $pagLink .= "<li><a class='current-page' href='view_sales_manager.php?page="  
                                                                                .$i."'>".$i." </a></li>";   
                                          }               
                                          else  {   
                                              $pagLink .= "<li><a href='view_sales_manager.php?page=".$i."'>   
                                                                                ".$i." </a></li>";     
                                          }   
                                        };     
                                        echo $pagLink;   
                                        ...
                                        if($page<$total_pages){   
                                            echo "<li><a href='view_sales_manager.php?page=".($page+1)."'> <i class='sl sl-icon-arrow-right'></i> </a></li>";   
                                        }   
