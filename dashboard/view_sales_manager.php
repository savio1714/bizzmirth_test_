...
<head>
    ...
    <title>View Sales Manager List | Bizzmirth Holidays</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="dashboard-list-box">
                            <h4 class="gray">View Sales Manager</h4>
                            <div class="table-box">
                            <table class="basic-table booking-table" id="viewtable">
                               <thead>
                                  <tr >
                                    <th scope="col">Sales Manager ID</th>
                                ...
                                <tbody>
                                     ...
                                     <?php
                                                ...
                                                $srno++;
                                                        ...
                                                        echo '<tr>
                                                    <td colspan="7">No sales_manager Register By You
                                                    </td>
                                                    <tr>';
                                                    }
              ?>
                            ...
                            <nav class="pagination">
                                <ul>
                                    ...
                                    echo "</br>";     
                                        ...
                                        if($page>=2){   
                                            echo "<li><a href='view_sales_manager?page=".($page-1)."'> <i class='sl sl-icon-arrow-left'></i> </a></li>";   
                                        }       
                                                   
                                        for ($i=1; $i<=$total_pages; $i++) {   
                                          if ($i == $page) {   
                                              $pagLink .= "<li><a class='current-page' href='view_sales_manager?page="  
                                                                                .$i."'>".$i." </a></li>";   
                                          }               
                                          else  {   
                                              $pagLink .= "<li><a href='view_sales_manager?page=".$i."'>   
                                                                                ".$i." </a></li>";     
                                          }   
                                        };     
                                        echo $pagLink;   
                                        ...
                                        if($page<$total_pages){   
                                            echo "<li><a href='view_sales_manager?page=".($page+1)."'> <i class='sl sl-icon-arrow-right'></i> </a></li>";   
                                        }   
...
<script type="text/javascript">
    ...
    var dataString = 'sales_manager_id='+ sales_manager_id+'&bm_id='+bm_id;
      ...
      $.ajax({
        type: "POST",
        url: "sales_manager/delete_sales_manager",
        data: dataString,
        cache: false,
    ...
    { 
        window.location.href='edit_sales_manager?vkvbvjfgfikix='+smid+'&ncy='+cut+'&mst='+st+'&hct='+ct;  
    };
