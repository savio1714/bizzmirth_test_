                                    ...
                                    <form>
                                     ...
                                     <div class="form-group col-md-6 col-sm-12">
                                       ...
                                       <div class="form-group col-md-12 col-sm-12">
                                                ...
                                                <input type="text"  id="package_name" placeholder="destination" >
                                                
                                            </div>
                                            
                                           <div class="form-group col-md-12 col-sm-12">
                                                <label>Location</label>
                                                <input type="text"  id="package_name" placeholder="Location" >
                                                
                                            </div>

                                            <div class="form-group col-md-12 col-sm-12">
                                                <label>Transfer From</label>
                                                <input type="text"  id="transferfrom" placeholder="" >
                                                
                                            </div>

                                            <div class="form-group col-md-12 col-sm-12">
                                                <label>Transfer To</label>
                                                <input type="text"  id="transferto" placeholder="" >
                                                
                                            </div>
                                            <div class="form-group col-md-12 col-sm-12">
                                                <label>No. Of Nights</label>
                                                <input type="text"  id="night" placeholder="" >
                                                
                                            </div>
                                        <div class="form-group col-md-12 col-sm-12">
                                                <label>Sightseeing Type</label>
                                                <input type="text"  id="sightseeing" placeholder="" >
