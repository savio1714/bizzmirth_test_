...
if($editfor == 'pending'){
    ...
    $stmt = $conn->prepare("SELECT *, (select city_name from cities where id = '".$city."'), (select state_name from states where id = '".$state."') as statename, (select city_name from cities where id = '".$city."') as city_name,(select country_name from countries where id = '".$country."') as countryname FROM `regional_manager` where $identifier_name'".$id."'");
    $stmt->execute();
            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        </li><li class="active-bre"><a href="regional_manager.php">Regional Manager </a>
                        </li>
                        <li class="active-bre"><a href="#"> Edit Regional Manager </a>
                        </li>
                        <li class="page-back"><a href="regional_manager.php"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
                        </li>
                    </ul>
                </div>
                <div class="sb2-2-3">
                                ...
                                <div class="tab-inn">
                                    ...
                                    <div class="form-group col-md-6 col-sm-12">
                                     ...
                                     <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" id="pin" placeholder="Pincode" value="<?php echo $pincode ;?>" readonly>
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="input-field col-md-col-md-12 col-sm-12">
                                                <input id="head_office" type="text" value="<?php echo $head_office;?>">
                                        ...
                                        <div class="row">
                                            <div class="input-field col-md-6 col-sm-12">
                                                <input id="zone_name" type="text" value="<?php echo $zone;?>">
                                                <label for="zone_name">Zone Name</label>
                                            </div>
                                            <div class="input-field col-md-6 col-sm-12">
                                                <input id="region_name" type="text" value="<?php echo $region;?>">
