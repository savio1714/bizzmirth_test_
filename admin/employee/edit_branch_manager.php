...
if($editfor == 'pending'){
    ...
    $stmt = $conn->prepare("SELECT *,(select CONCAT(firstname,' ',lastname) from regional_manager where regional_manager_id = '".$reference_no."') as fname, (select city_name from cities where id = '".$city."'), (select state_name from states where id = '".$state."') as statename, (select city_name from cities where id = '".$city."') as city_name,(select country_name from countries where id = '".$country."') as countryname FROM `branch_manager` where $identifier_name'".$id."'");
    $stmt->execute();
            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        </li><li class="active-bre"><a href="branch_manager">Branch Manager </a>
                        </li>
                        <li class="active-bre"><a href="#"> Edit Branch Manager </a>
                        </li>
                        <li class="page-back"><a href="branch_manager"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
                        </li>
                    </ul>
                </div>
                <div class="sb2-2-3">
