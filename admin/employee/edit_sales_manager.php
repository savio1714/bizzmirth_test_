            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        </li><li class="active-bre"><a href="sales_manager">Sales Manager </a>
                        </li>
                        <li class="active-bre"><a href="#"> Edit Sales Manager </a>
                        </li>
                        <li class="page-back"><a href="sales_manager"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
                        </li>
                    </ul>
                </div>
                <div class="sb2-2-3">
