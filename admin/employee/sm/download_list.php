...
$output="";
    ...
    if($name == 'Pending'){
        header("Content-Disposition: attachment;filename=Pending_Sales_Manager_List.xls");
    }else if($name == 'Registered'){
        header("Content-Disposition: attachment;filename=Registered_Sales_Manager_List.xls");
    }
