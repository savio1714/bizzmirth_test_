...
$output="";
    ...
    if($name == 'Pending'){
        header("Content-Disposition: attachment;filename=Pending_Branch_Manager_List.xls");
    }else if($name == 'Registered'){
        header("Content-Disposition: attachment;filename=Registered_Branch_Manager_List.xls");
    }
