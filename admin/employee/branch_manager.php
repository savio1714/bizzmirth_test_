            ...
            <div class="sb2-2">
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#">Branch Manager</a>
                        </li>
                                        ...
                                        <table class="table table-hover" id="pendingTable">
                                            ...
                                            <tbody>
                                                ...
                                                $srno++;
                                                        ...
                                                        echo '<tr>
                                                    <td colspan="8">No Pending Branch Manager
                                                    </td>
                                                    <tr>';
                                                    }
              ?>  
                                        ...
                                        <table class="table table-hover" id="registerTable">
                                            ...
                                            <tbody>
                                                ...
                                                if($stmt->rowCount()>0){
                                                    ...
                                                    $stmt2 = $conn->prepare("SELECT * FROM login where user_type_id='6' and (status='1' or status='3') and user_id='".$row['branch_manager_id']."' ");
                                                    $stmt2->execute();
                                               ...
                                               echo ' </tr>';
                                                ...
                                                $srno++;
                                                        ...
                                                        echo '<tr>
                                                    <td colspan="8">Not Registered Branch Manager
                                                    </td>
                                                    <tr>';
                                                    }
                                                ?> 
