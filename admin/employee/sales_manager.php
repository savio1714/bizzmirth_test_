                            ...
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    ...
                                    <ul id="dr-users" class="dropdown-content">
                                        <li><a href="add_sales_manager">Add Sales Manager</a>
                                        </li>
                                        <li><a href="sm/download_list?vkvbvjfgfikix=Pending">Download List</a>
                                       </li>
...
<script type="text/javascript">
    ...
    { 
        window.location.href='edit_sales_manager?vkvbvjfgfikix='+id+'&nohbref='+refno+'&ncy='+cut+'&mst='+st+'&hct='+ct+'&editfor='+editfor;  
    };
